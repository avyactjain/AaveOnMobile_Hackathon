...
class BorrowBroadcastSuccessModal extends StatelessWidget {
  final localTxObj;
  final Function() onDonePressed;

  BorrowBroadcastSuccessModal(
      {@required this.localTxObj, @required this.onDonePressed});
  @override
  Widget build(BuildContext context) {
    print(jsonEncode(localTxObj));
    return Container(
        ...
        children: [
          ...
          RichText(
            ...
            text: TextSpan(children: [
              TextSpan(
                  text:
                      "Successfully borrowed ${localTxObj["txnParamsByUser"]["amount"]} ${localTxObj["borrowApiResponseObj"]["token"]} from Aave ",
                  style: Theme.of(context).textTheme.headline1),
              // WidgetSpan(
              //     child: WalletAddressText(
              //   walletAddress: localTxObj["withdrawApiResponseObj"]["to_addr"],
              //   style: Theme.of(context).textTheme.headline1,
              // ))
            ]),
          ),
