...
class CollateralToggleSuccessModal extends StatelessWidget {
  final localTxObj;
  final Function() onDonePressed;
  CollateralToggleSuccessModal(
      {@required this.localTxObj, @required this.onDonePressed});
  @override
  Widget build(BuildContext context) {
    String _onOffString =
        localTxObj["txnParamsByUser"]["useAsCollateral"] ? "On" : "Off";
        ...
        children: [
          ...
          RichText(
            ...
            text: TextSpan(children: [
              TextSpan(
                  text:
                      "Successfully turned collateral $_onOffString for ${localTxObj["txnParamsByUser"]["token"]}",
